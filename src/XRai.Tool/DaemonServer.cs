    ...
    private void WireRouter()
    {
        ...
        _router.Register("sta.reset", _ =>
        {
            ...
            try
            {
                ...
                // single command (saves two follow-up round-trips).
                ...
                if (excelAttached)
                {
                    try { _hookConnection.TryAutoConnect(); hooksAttached = _hookConnection.IsConnected; }
                ...
                return Response.Ok(new
                {
                    ...
                    hint = excelAttached
                        ? (hooksAttached
                            ? "STA recycled and fully reattached."
                            : "STA recycled and Excel reattached. Hooks not found (no pilot running).")
